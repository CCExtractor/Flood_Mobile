                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          (model.RssFeedsList.isNotEmpty)
                              ...
                              : Container(
                                  key: Key(
                                      'No existing feeds displaying container'),
                                  height: 60,
                                  width: double.infinity,
                                  color: ThemeProvider.theme.primaryColorLight,
                                                                          ...
                                                                          children: <
                                                                            ...
                                                                            TextField(
                                                                              ...
                                                                              decoration: InputDecoration(
                                                                                ...
                                                                                labelStyle: TextStyle(fontFamily: 'Montserrat', color: ThemeProvider.theme.textTheme.bodyText1?.color),
                                                                                border: OutlineInputBorder(
                                                                                  borderRadius: BorderRadius.circular(8),
                                                                                ),
                                                                              ),
                                                              ...
                                                              children: [
                                                                Expanded(
                                                                  child: Row(
                                                                    children: [
                                                                      Text(
                                                                          model.RssFeedsContentsList[index].title.toString().length < 38
                                                                              ? model.RssFeedsContentsList[index].title.toString()
